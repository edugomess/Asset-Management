<?php
/**
 * ADICIONAR ARTIGO: adicionar_artigo.php
 * Formulário para criação de novos tutoriais e soluções na Base de Conhecimento.
 */
...
<head>
    ...
    <title><?php echo __('Novo Artigo'); ?> - Asset Mgt</title>
    ...
    <style>
        .note-editor { border-radius: 10px; border: 1px solid #ddd !important; }
        .note-toolbar { background: #f8f9fc !important; border-top-left-radius: 10px; border-top-right-radius: 10px; }
    </style>
</head>
                        ...
                        <div class="card-body">
                            <form action="processar_kb.php" method="POST">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="titulo" class="form-control form-control-lg premium-input" 
                                                placeholder="<?php echo __('Ex: Como configurar VPN Cisco'); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="categoria" class="form-control form-control-lg premium-input" required>
                                                ...
                                                <option value="Rede"><?php echo __('Rede & Conectividade'); ?></option>
                                                <option value="Segurança"><?php echo __('Segurança'); ?></option>
                                                <option value="Procedimentos"><?php echo __('Procedimentos Internos'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <small class="text-muted"><?php echo __('Essas tags ajudam os usuários a encontrar o artigo mais rápido.'); ?></small>
                                </div>
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="submit" class="btn btn-primary px-5 shadow-sm" style="background: #2c404a; border: none; border-radius: 10px; height: 50px; font-weight: 600;">
                                        <i class="fas fa-save mr-2"></i><?php echo __('Publicar Artigo'); ?>
                                    </button>
                                </div>
                            </form>
                        </div>
