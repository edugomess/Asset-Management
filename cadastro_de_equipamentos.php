                            ...
                            <form id="assetForm" action="inserir_equipamento.php" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="categoria"><?php echo __('Categoria'); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="fabricante"><?php echo __('Fabricante'); ?></label>
                                            <input class="form-control" name="fabricante" id="fabricante" type="text"
                                                placeholder="<?php echo __('Ex: Dell, HP, Apple'); ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="modelo"><?php echo __('Modelo'); ?></label>
                                            <input class="form-control" name="modelo" id="modelo" type="text"
                                                placeholder="<?php echo __('Ex: Latitude 3420'); ?>" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="numero_serie"><?php echo __('Número de Série'); ?></label>
                                            <input class="form-control" name="numero_serie" id="numero_serie"
                                                type="text" placeholder="<?php echo __('Ex: 123456789'); ?>"
                                                required="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="tag"><?php echo __('Tag de Serviço'); ?></label>
                                            <?php
                                            ...
                                            <input class="form-control" name="tag" id="tag" type="text"
                                                value="<?php echo $preview_tag; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-3" id="hostnameContainer">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="hostName"><?php echo __('Host Name'); ?></label>
                                            <input class="form-control" name="hostName" id="hostName" type="text"
                                                placeholder="<?php echo __('Ex: NOTE-001'); ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="macAdress"><?php echo __('Endereço MAC'); ?></label>
                                            <input class="form-control" name="macAdress" id="macAdress" type="text"
                                                placeholder="<?php echo __('Ex: 00:00:00:00:00:00'); ?>" required="">
                                        </div>
                                    </div>
                                </div>

                                <!-- Row 3: Atribuição e Localização -->
                                <h5 class="text-primary font-weight-bold mt-4 mb-3">
                                    <?php echo __('Atribuição e Localização'); ?></h5>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="assigned_type"><?php echo __('Tipo de Atribuição'); ?></label>
                                            <select class="form-control" name="assigned_type" id="assigned_type">
                                                <option value="Usuario">
                                                    <?php echo __('Responsabilidade Individual (Usuário)'); ?></option>
                                                <option value="Local">
                                                    <?php echo __('Responsabilidade Coletiva (Infraestrutura)'); ?>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3" id="user_assignment">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="assigned_to"><?php echo __('Atribuído a'); ?></label>
                                    ...
                                    <div class="col-md-3" id="location_assignment" style="display: none;">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="id_local"><?php echo __('Local de Instalação'); ?></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="parent_asset_id"><?php echo __('Vincular a Ativo Pai'); ?></label>
                                            ...
                                            <small
                                                class="text-muted"><?php echo __('Ex: Monitor vinculado a um Desktop.'); ?></small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="centroDeCusto"><?php echo __('Centro de Custo'); ?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6" id="tier_container">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="tier"><?php echo __('Tier / Nível de Atribuição'); ?></label>
                                            <select class="form-control" name="tier" id="tier" required="">
                                                <option value=""><?php echo __('Selecione um Tier...'); ?></option>
                                                ...
                                                <option value="Infraestrutura"><?php echo __('Infraestrutura'); ?>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6" id="setor_container">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="setor"><?php echo __('Setor / Departamento'); ?></label>
                                            <input class="form-control" name="setor" id="setor" type="text"
                                                placeholder="<?php echo __('Ex: Financeiro'); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h5 class="text-primary font-weight-bold mt-4 mb-3">
                                    <?php echo __('Dados Financeiros e Status'); ?></h5>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="valor"><?php echo __('Valor do Ativo (R$)'); ?></label>
                                            <input class="form-control" name="valor" id="valor" type="number"
                                                step="0.01" placeholder="<?php echo __('Ex: 4500.00'); ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="status_new"><?php echo __('Status do Ativo'); ?></label>
                                            <select class="form-control" name="status" id="status_new">
                                                ...
                                                <option value="Em manutenção"><?php echo __('Em manutenção'); ?>
                                                </option>
                                                <option value="Descartado/Leilão"><?php echo __('Descartado/Leilão'); ?>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="fornecedor"><?php echo __('Fornecedor'); ?></label>
                                ...
                                <!-- Row 4: Dados Compra -->
                                <h5 class="text-primary font-weight-bold mt-4 mb-3">
                                    <?php echo __('Dados de Compra / Nota Fiscal'); ?></h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="numero_nota_fiscal"><?php echo __('Nota Fiscal/Chave de Acesso'); ?></label>
                                            <input class="form-control" name="numero_nota_fiscal"
                                                id="numero_nota_fiscal" type="text"
                                                placeholder="<?php echo __('Ex: 352603...'); ?>" required
                                                pattern="\d{44}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="anexo_nota_fiscal"><?php echo __('Anexar Nota Fiscal (PDF/Imagem)'); ?></label>
                                            <input class="form-control-file" name="anexo_nota_fiscal"
                                                id="anexo_nota_fiscal" type="file" accept=".pdf,image/*">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="hardwareSection"
                                    style="display: none; border-left: 4px solid #2c404a; padding-left: 15px; margin-bottom: 25px; background: #f8f9fc; border-radius: 5px;">
                                    <h5 class="text-primary font-weight-bold mb-3">
                                        <?php echo __('Especificações de Hardware'); ?></h5>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="memoria"><?php echo __('Memória RAM'); ?></label>
                                                <input class="form-control" name="memoria" id="memoria" type="text"
                                                    placeholder="<?php echo __('Ex: 16GB DDR4'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="processador"><?php echo __('Processador'); ?></label>
                                                <input class="form-control" name="processador" id="processador"
                                                    type="text" placeholder="<?php echo __('Ex: Intel i7'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="armazenamento"><?php echo __('Capacidade Armazenamento'); ?></label>
                                                <input class="form-control" name="armazenamento" id="armazenamento"
                                                    type="text" placeholder="<?php echo __('Ex: 512GB'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="tipo_armazenamento"><?php echo __('Tipo de Armazenamento'); ?></label>
                                                <select class="form-control" name="tipo_armazenamento"
                                                    id="tipo_armazenamento">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3" id="gpu_container" style="display: none;">
                                            <div class="form-group mb-0">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="gpu"><?php echo __('Placa Gráfica (GPU)'); ?></label>
                                                <input class="form-control" name="gpu" id="gpu" type="text"
                                                    placeholder="<?php echo __('Ex: NVIDIA RTX 4090 24GB'); ?>">
                                            </div>
                                        </div>
                                        <!-- Polegadas (Monitor) -->
                                        <div class="col-md-12 mt-3" id="inches_container" style="display: none;">
                                            <div class="form-group mb-0">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="polegadas"><?php echo __('Polegadas (Monitor)'); ?></label>
                                        ...
                                        <div class="col-md-12 mt-3" id="scanner_container" style="display: none;">
                                            <div class="form-group mb-0">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="is_scanner"><?php echo __('Possui Scanner? (Multifuncional)'); ?></label>
                                                <select class="form-control" name="is_scanner" id="is_scanner">
                                                    <option value="Não"><?php echo __('Não (Impressora Simples)'); ?>
                                                    </option>
                                                    <option value="Sim"><?php echo __('Sim (Multifuncional)'); ?>
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <!-- Smartphone Section -->
                                <div id="smartphoneSection"
                                    style="display: none; border-left: 4px solid #007bff; padding-left: 15px; margin-bottom: 25px; background: #f0f7ff; border-radius: 5px;">
                                    <h5 class="text-primary font-weight-bold mb-3">
                                        <?php echo __('Dados do Smartphone'); ?></h5>
                                    <div class="row py-2">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="imei"><?php echo __('IMEI'); ?></label>
                                                <input class="form-control" name="imei" id="imei" type="text"
                                                    placeholder="<?php echo __('Ex: 351234567890123'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="text-gray-600 small font-weight-bold"
                                                    for="sim_card"><?php echo __('SIM Card (Número/ICCID)'); ?></label>
                                                <input class="form-control" name="sim_card" id="sim_card" type="text"
                                                    placeholder="<?php echo __('Ex: 89551234567890123456'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="dataAtivacao"><?php echo __('Data de Cadastro'); ?></label>
                                            <input class="form-control" name="dataAtivacao" id="dataAtivacao"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="imagem"><?php echo __('Imagem do Ativo'); ?></label>
                                            <input class="form-control-file" name="imagem" id="imagem" type="file"
                                                accept="image/*">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold"
                                                for="descricao"><?php echo __('Observações Adicionais'); ?></label>
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col-12 d-flex justify-content-end align-items-center"
                                        ...
                                        <a class="btn btn-secondary" href="equipamentos.php"
                                            style="border-radius: 10px; padding: 10px 30px; font-weight: 600;"><?php echo __('Voltar'); ?></a>
                                        <button class="btn btn-primary" type="submit"
                                            style="background: #2c404a; border: none; border-radius: 10px; padding: 10px 30px; font-weight: 600;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 bg-light"
                    ...
                    <h5 class="modal-title font-weight-bold text-success"><i
                            class="fas fa-check-circle mr-2"></i><?php echo __('Equipamento Cadastrado!'); ?></h5>
                </div>
                <div class="modal-body text-center p-4">
                    <p class="mb-4 text-muted">
                        <?php echo __('A etiqueta patrimonial já está pronta para identificação física.'); ?></p>
                    <div class="p-3 bg-white d-inline-block rounded shadow-sm mb-3" style="border: 1px dashed #ddd;">
                        <div id="qrcode_reg"></div>
                    </div>
                    <div class="mt-2"><span class="badge badge-dark p-2" id="tag_badge_reg"
                            style="font-size: 1.2rem; border-radius: 10px; letter-spacing: 1px;"></span></div>
                </div>
                <div class="modal-footer border-0 p-4 flex-column">
                    <button type="button" class="btn btn-primary btn-block p-3 font-weight-bold mb-2" id="btn-print-reg"
                        style="border-radius: 12px;"><i
                            class="fas fa-print mr-2"></i><?php echo __('Imprimir Etiqueta Agora'); ?></button>
                    <div class="d-flex w-100" style="gap: 10px;">
                        <button type="button" class="btn btn-outline-secondary flex-fill" onclick="location.reload();"
                            style="border-radius: 10px;"><?php echo __('Novo Cadastro'); ?></button>
                        <a href="equipamentos.php" class="btn btn-outline-primary flex-fill"
                            style="border-radius: 10px;"><?php echo __('Ver Inventário'); ?></a>
                    </div>
                </div>
            </div>
        </div>
