...
<head>
    ...
    <title><?php echo __('Cadastro de Licença'); ?> - Asset MGT</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold" for="software"><?php echo __('Nome do Software'); ?></label>
                                            <input class="form-control" name="software" id="software" type="text" placeholder="<?php echo __('Ex: Microsoft Office 2021'); ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold" for="chave"><?php echo __('Chave de Ativação'); ?></label>
                                            <input class="form-control" name="chave" id="chave" type="text" placeholder="<?php echo __('XXXXX-XXXXX-XXXXX-XXXXX-XXXXX'); ?>" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="fabricante" id="fabricante" type="text" placeholder="<?php echo __('Ex: Microsoft'); ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipo" id="tipo" required="">
                                                ...
                                                <option value="Assinatura"><?php echo __('Assinatura (SaaS)'); ?></option>
                                                <option value="OEM"><?php echo __('OEM'); ?></option>
                                                <option value="Volume"><?php echo __('Volume (VLK)'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="quantidade_total" id="quantidade_total" type="number" placeholder="<?php echo __('Ex: 10'); ?>" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="valor_unitario" id="valor_unitario" type="number" step="0.01" placeholder="<?php echo __('Ex: 150.00'); ?>" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_centro_custo" id="id_centro_custo">
                                                ...
                                                if ($result_cc && $result_cc->num_rows > 0) {
                                                    while ($row_cc = $result_cc->fetch_assoc()) {
                                                        echo '<option value="' . $row_cc['id_centro_de_custo'] . '">' . __($row_cc['nomeSetor']) . '</option>';
                                                    }
                                                }
                                                ?>
                                            </select>
