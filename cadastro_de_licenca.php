        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(44,64,74);">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/licencas.php"><i class="fas fa-key"></i><span> Licenças</span></a></li>
                ...
                <form action="inserir_licenca.php" method="post">
                    <div class="form-row">
                        <div class="col-sm-6 col-xl-4 offset-xl-1">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="software" type="text" placeholder="Ex: Microsoft Office 365" required="">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4 offset-xl-1">
                            <div class="form-group">
                                <label>Fabricante</label>
                                <input class="form-control" name="fabricante" type="text" placeholder="Ex: Microsoft" required="">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="col-sm-6 col-xl-4 offset-xl-1">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="chave" type="text" placeholder="XXXXX-XXXXX-XXXXX-XXXXX">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="col-sm-4 col-xl-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="valor_unitario" type="number" step="0.01" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-xl-2">
                             <label>Data de Aquisição</label>
                             <input class="form-control" name="data_aquisicao" type="date" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                        <div class="col-xl-2">
                    ...
                    <div class="form-row">
                        <div class="col-xl-4 offset-xl-4">
                            <button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 50px;">Cadastrar Licença</button>
                        </div>
                    </div>
                </form>
