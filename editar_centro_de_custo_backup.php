            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/usuarios.php"><i class="fas fa-user-alt"></i><span>
                                Usuários</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="/centro_de_custo.php"><i
                        ...
                        <div class="form-row">
                            <div class="col-sm-3 col-xl-4 offset-xl-1">
                                <div class="form-group"><label></label><input class="form-control" name="nomeSetor"
                                        type="text" value="<?php echo $nomeSetor ?>"></div>
                            </div>
                            <div class="col-xl-2 offset-xl-1">
                                <div class="form-group"><label></label><input class="form-control" name="codigo" type="text"
                                        value="<?php echo $codigo ?>"></div>
                            </div>
                            <div class="col-xl-2">
                                <div class="input-group mb-4">
                                    <div class="input-group-prepend"></div><input class="form-control" name="ramal"
                                        type="text" value="<?php echo $ramal ?>"
                                        style="border-radius: 5.6px;margin-top: 24px;">
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-3 col-xl-4 offset-xl-1">
                                <div class="form-group"><label></label><input class="form-control" name="emailGestor"
                                        type="text" value="<?php echo $emailGestor ?>"></div>
                            </div>
                            <div class="col-sm-3 col-xl-1">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group"><label></label><input class="form-control" name="gestor" type="text"
                                        value="<?php echo $gestor ?>"></div>
                            </div>
                            <div class="col-sm-4 col-xl-2" style="margin-top: 23px;">
                                <!-- Start: Date Range Picker -->
                                <div class="form-group"><select class="form-control" style="margin: 23px,0px;" name="status"
