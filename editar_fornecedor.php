                            ...
                            <form action="update_fornecedor.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nomeEmpresa" id="nomeEmpresa" type="text" value="<?php echo htmlspecialchars($fornecedor['nomeEmpresa']); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold" for="cnpj"><?php echo __('CNPJ'); ?></label>
                                            <input class="form-control" name="cnpj" id="cnpj" type="text" value="<?php echo htmlspecialchars($fornecedor['cnpj']); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" id="email" type="email" value="<?php echo htmlspecialchars($fornecedor['email']); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold" for="telefone"><?php echo __('Telefone / WhatsApp'); ?></label>
                                            <input class="form-control" name="telefone" id="telefone" type="text" value="<?php echo htmlspecialchars($fornecedor['telefone']); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="servico" id="servico" type="text" value="<?php echo htmlspecialchars($fornecedor['servico']); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold" for="site"><?php echo __('Site / URL'); ?></label>
                                            <input class="form-control" name="site" id="site" type="url" value="<?php echo htmlspecialchars($fornecedor['site']); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-2 text-center">
                                        <label class="text-gray-600 small font-weight-bold d-block"><?php echo __('Logo / Imagem'); ?></label>
                                        <img src="<?php echo !empty($fornecedor['imagem']) ? htmlspecialchars($fornecedor['imagem']) : '/assets/img/avatars/avatar1.jpeg'; ?>"
                                            class="img-thumbnail" style="width: 80px; height: 80px; object-fit: cover;">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-gray-600 small font-weight-bold" for="imagem"><?php echo __('Alterar Imagem do Fornecedor'); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="custom-control custom-switch" style="margin-top: 15px;">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="statusSwitch" name="status" value="Ativo" <?php echo ($fornecedor['status'] == 'Ativo') ? 'checked' : ''; ?>>
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col-12 d-flex justify-content-end align-items-center" style="gap: 15px;">
                                        <a class="btn btn-secondary" href="fornecedores.php" 
