        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/fornecedores.php"><i
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    <div class="col-sm-6 col-xl-4 offset-xl-1">
                                        <div class="form-group"><label></label><input class="form-control"
                                                name="nomeEmpresa" type="text" type="text"
                                                value="<?php echo $nomeEmpresa ?>"></div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-xl-1"><select class="form-control" name="status" type="text"
                                            value="<?php echo $status ?>"
                                            style="margin: 23px;margin-right: 0px;margin-bottom: 0px;margin-left: 0px;"
                                            required="">
