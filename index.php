...
<body id="page-top">
    ...
    <?php
    // session_start() notice fix: removed redundant includes here as they are already included via include_once at the top.
    ...
    $res = mysqli_query($conn, "SELECT status, COUNT(*) as total FROM chamados WHERE status IN ('Aberto', 'Em
    Andamento', 'Pendente') GROUP BY status");
    if ($res) {
    ...
    $res_closed = mysqli_query($conn, "SELECT MONTH(data_fechamento) as month, COUNT(*) as count FROM chamados WHERE
    status IN ('Resolvido', 'Fechado', 'Cancelado') AND YEAR(data_fechamento) = YEAR(CURRENT_DATE()) GROUP BY
    MONTH(data_fechamento)");
    if ($res_closed) {
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center"
                                        ...
                                        <div class="dropdown no-arrow"><button
                                            ...
                                            <div class="dropdown-menu shadow dropdown-menu-right animated--fade-in">
                                                <p class="text-center dropdown-header">Opções:</p><a
                                                    class="dropdown-item"
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="dropdown no-arrow"><button
                                            ...
                                            <div class="dropdown-menu shadow dropdown-menu-right animated--fade-in">
                                                <p class="text-center dropdown-header">Opções:</p><a
                                                    class="dropdown-item" href="chamados.php">&nbsp;Ver Chamados</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
