...
<form action="autenticador.php" method="post">   
    ...
    <footer class="footer-dark", style="padding: 15px; padding-top: 0px," >
        <div class="container">
            <div class="row">
                <!-- Start: Services -->
                ...
                <div class="col-md-6 item text">
                    ...
                    <p>Praesent sed lobortis mi. Suspendisse vel placerat ligula.</p>
                </div><!-- End: Footer Text -->
            </div><!-- Start: Copyright -->
            <p class="copyright">DEGB©2024</p><!-- End: Copyright -->
        </div>
