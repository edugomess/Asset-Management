    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(44,64,74);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-icon rotate-n-15"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-car" style="width: 30px;height: 30px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/table-2.html"><i class="fas fa-table"></i><span>Clientes </span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/table-3.html"><i class="fas fa-table"></i><span>Fornecedores </span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/table-4.html"><i class="fas fa-table"></i><span>Produtos </span></a><a class="nav-link" href="/table.html"><i class="fa fa-list"></i><span>Relatórios</span></a><a class="nav-link" href="/blank-4.html"><i class="fa fa-support"></i><span>Suporte</span></a><a class="nav-link" href="/login.html"><i class="far fa-user-circle"></i><span>Login</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop-1" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">Eduardo Gomes</span><img class="border rounded-circle img-profile" src="/assets/img/avatars/Captura%20de%20Tela%202021-08-04%20às%2012.25.13.png"></a>
            ...
            <footer class="bg-white sticky-footer" style="background: rgb(34,40,39);padding: 0;">
                ...
                <section class="text-center footer" style="padding: 10px;margin-top: 70px;">
                    <!-- Start: Footer text -->
                    <p style="margin-bottom: 0px;font-size: 15px;">DEGB&nbsp;Copyright © 2015-2021&nbsp;<br></p><!-- End: Footer text -->
