...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <div class="sidebar-brand-icon rotate-n-15"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                            ...
                            stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-car"
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Algo </span></div>
                </a>
                <hr class="sidebar-divider my-0">
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="/index.html"><i
                                class="fas fa-tachometer-alt"></i><span>Dashboard</span></a><a class="nav-link"
                            href="/blank-3.html"><i class="fa fa-money"></i><span>Início</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/table-1.html"><i
                                class="fas fa-table"></i><span>Usuários</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/table-2.html"><i
                                class="fas fa-table"></i><span>Cliente</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/table-3.html"><i
                                class="fas fa-table"></i><span>Fornecedore</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/table-4.html"><i
                                class="fas fa-table"></i><span>Produtos</span></a><a class="nav-link"
                            href="/table.html"><i class="fa fa-list"></i><span>Relatórios</span></a><a class="nav-link"
                            href="/blank-4.html"><i class="fa fa-support"></i><span>Suporte</span></a><a
                            class="nav-link" href="/login.html"><i class="far fa-user-circle"></i><span>Login</span></a>
                    </li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        aria-expanded="false" data-toggle="dropdown" href="#"><span
                                            ...
                                            src="/assets/img/avatars/Captura%20de%20Tela%202021-08-04%20às%2012.25.13.png"></a>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Batata</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4"
                                    ...
                                    <div class="mb-3"><button class="btn btn-primary btn-sm" type="button"
                                            style="background: rgb(44,64,74);">Change Photo</button></div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                for="username"><strong>Apelido</strong></label><input
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                for="last_name"><strong>Sobrenome</strong></label><input
                                                ...
                                                <div class="form-group"><button class="btn btn-primary btn-sm"
                                                        type="submit" style="background: rgb(44,64,74);">Save
                                                        Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <div class="form-group"><button class="btn btn-primary btn-sm"
                                                        type="submit"
                                                        style="background: rgb(44,64,74);">Save&nbsp;Settings</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <form>
                                        ...
                                        <div class="form-group"><button class="btn btn-primary btn-sm" type="submit"
                                                style="background: rgb(44,64,74);">Save Settings</button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script src="/assets/js/Password-Strenght-Checker---Ambrodu.js"></script>
