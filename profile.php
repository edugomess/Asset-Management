                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4"
                                        src="<?php echo !empty($user_data['foto_perfil']) ? htmlspecialchars($user_data['foto_perfil']) : '/assets/img/avatars/Captura%20de%20Tela%202021-08-04%20às%2012.25.13.png?h=fcfb924f0ac1ab5f595f029bf526e62d'; ?>"
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Usuário
                                                                    AD</strong></label><input class="form-control"
                                                                type="text"
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="text-primary font-weight-bold m-0">Licenças Atribuídas</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (mysqli_num_rows($result_lic) > 0) {
                                                            ...
                                                            echo "<tr><td colspan='5'>Nenhuma licença atribuída.</td></tr>";
                                                        }
                                                        ?>
                                                    </tbody>
                                                </table>
