...
$columns = [
    ['header' => 'Usuário (Setor)', 'width' => 80, 'align' => 'L', 'field' => 'nome'],
...
$sql = "SELECT CONCAT(u.nome, ' ', u.sobrenome, ' (', COALESCE(u.setor, '-'), ')') as nome, COUNT(a.id_asset) as qtd_ativos, SUM(a.valor) as valor_total 
        FROM usuarios u 
