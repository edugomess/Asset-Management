    ...
    <a href="relatorio_ativo.php" style="display: block; text-decoration: none;">
        <button class="btn btn-success btn-block active text-white pulse animated btn-user" type="button" style="background: rgb(44,64,74); border-radius: 10px; padding: 30px; border-width: 0px; height: 50px; margin-top: 23px;">
            Ativos
                                ...
                                <div href="relatorio_ativo.php"class="col-md-6 col-xl-2"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Usuários</button></a></div>
                                ...
                                <div class="col-xl-2"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Usuários</button></div>
                                <div class="col-xl-2"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Monitores</button></div>
                                <div class="col-xl-2"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Mouses</button></div>
                                <div class="col-xl-2"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Teclados</button></div>
                                <div class="col"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Saidas</button></div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
