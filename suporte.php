    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(44,64,74);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/suporte.php"><i class="fas fa-user-cog"></i><span> Suporte</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                                ...
                                <form>
                                    <div class="form-row">
                                        <div class="col col-contact">
                                            <div class="form-group modern-form__form-group--padding-r"><input class="form-control input input-tr" type="text" placeholder="Nome">
                                                <div class="line-box">
                                                    <div class="line"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col col-contact">
                                            <div class="form-group modern-form__form-group--padding-r"><input class="form-control input input-tr" type="text" placeholder="Empresa">
                                                <div class="line-box">
                                                    <div class="line"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col col-contact">
                                            <div class="form-group modern-form__form-group--padding-l"><input class="form-control input input-tr" type="text" placeholder="E-Mail">
                                                <div class="line-box">
                                                    <div class="line"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group modern-form__form-group--padding-t"><textarea class="form-control input modern-form__form-control--textarea" placeholder="Messagem"></textarea>
                                                <div class="line-box">
                                                    <div class="line"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-xl-3 offset-xl-4 text-center"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;margin-top: 23px;">Enviar</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="container">
                    <!-- Start: Map Clean -->
                    <section class="map-clean"><iframe allowfullscreen="" frameborder="0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBPk6EEDKnLhNYxq-pI77Q4934lsuEC318&amp;q=AV.Mario+cola+Francisco%2C+210+Campos+do+Jord%C3%A3o%2C+SP%2C+Brasil&amp;zoom=15" width="100%" height="450"></iframe></section><!-- End: Map Clean -->
                </div>
            </div>
