        ...
        <div class="table-responsive">
            <table class="table mb-0" id="techTable">
                ...
                <tbody>
                    ...
                    <!-- IA ENGINE -->
                    <tr><td><span class="badge badge-pill badge-info badge-pill-custom">IA Engine</span></td><td><strong>Google Gemini API</strong></td><td><span class="tech-version">2.0 Flash / 1.5 Pro</span></td><td>Assistente inteligente para suporte técnico, análise de prioridade e resoluções automatizadas.</td></tr>
                    <tr><td><span class="badge badge-pill badge-info badge-pill-custom">IA Engine</span></td><td><strong>GitHub Models</strong></td><td><span class="tech-version">GPT-4o Mini (Fallback)</span></td><td>Infraestrutura de alta disponibilidade para processamento de linguagem natural.</td></tr>
                    ...
                    <tr><td><span class="badge badge-pill badge-success badge-pill-custom">Innovation</span></td><td><strong>Hybrid Media Storage</strong></td><td><span class="tech-version">Filesystem / AJAX</span></td><td>Migração de Base64 para armazenamento em disco, otimizando a performance do banco de dados.</td></tr>
                    <tr><td><span class="badge badge-pill badge-success badge-pill-custom">Innovation</span></td><td><strong>Dynamic SLA Engine</strong></td><td><span class="tech-version">Prioridade x Categoria</span></td><td>Cálculo inteligente de prazos de atendimento baseado na matriz de criticidade.</td></tr>
                    ...
                    <!-- UX / FRONTEND -->
                    <tr><td><span class="badge badge-pill badge-danger badge-pill-custom">UX Design</span></td><td><strong>Bootstrap</strong></td><td><span class="tech-version">4.6.1</span></td><td>Grid responsivo e componentes reativos de interface humana.</td></tr>
                    ...
                    <tr><td><span class="badge badge-pill badge-warning badge-pill-custom">JS Engine</span></td><td><strong>NProgress.js</strong></td><td><span class="tech-version">0.2.0</span></td><td>Barra de progresso premium para carregamento de páginas e requisições longas.</td></tr>
                    ...
                    <tr><td><span class="badge badge-pill badge-dark badge-pill-custom">Protocols</span></td><td><strong>Security MIME</strong></td><td><span class="tech-version">finfo / PHP</span></td><td>Validação rigorosa de extensões e tipos de arquivo durante uploads.</td></tr>
                    <!-- INFRA -->
