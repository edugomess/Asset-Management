            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/index.php"><i
                            ...
                            href="/inicio.php"><i class="fa fa-money"></i><span>Início</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/usuários.php"><i
                                class="fas fa-table"></i><span>Usuários</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/centro_de_custo.php"><i
                                class="fas fa-table"></i><span>Centro de Custo</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/fornecedores.php"><i
                                class="fas fa-table"></i><span>Fornecedores</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="/equipamentos.php"><i
                                class="fas fa-table"></i><span>Equipamentos</span></a><a class="nav-link"
                            href="/relatorios.php"><i class="fa fa-list"></i><span>Relatórios</span></a><a
                            class="nav-link" href="/suporte.html"><i
                                class="fa fa-support"></i><span>Suporte</span></a><a class="nav-link"
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        aria-expanded="false" data-toggle="dropdown" href="#"><span
                                            class="d-none d-lg-inline mr-2 text-gray-600 small">Eduardo Gomes</span><img
                                            class="border rounded-circle img-profile"
                                            src="/assets/img/avatars/Captura%20de%20Tela%202021-08-04%20às%2012.25.13.png?h=fcfb924f0ac1ab5f595f029bf526e62d"></a>
                ...
                <form>
                    ...
                    <div class="form-row">
                        <div class="col-sm-3 col-xl-4 offset-xl-1">
                            <div class="form-group"><label></label><input class="form-control" type="email"
                                    placeholder="Nome do Setor"></div>
                        </div>
                        <div class="col-xl-2 offset-xl-1">
                            <div class="form-group"><label></label><input class="form-control" type="tel"
                                    placeholder="Código"></div>
                        </div>
                        <div class="col-xl-2">
                            <div class="input-group mb-4">
                                <div class="input-group-prepend"></div><input class="form-control" type="text"
                                    id="datePicker" placeholder="Ramal" style="border-radius: 5.6px;margin-top: 24px;">
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-sm-3 col-xl-4 offset-xl-1">
                            <div class="form-group"><label></label><input class="form-control" type="text"
                                    placeholder="E-mail do Gestor"></div>
                        </div>
                        <div class="col-sm-3 col-xl-1">
